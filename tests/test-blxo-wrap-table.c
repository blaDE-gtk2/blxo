...
main (gint argc, gchar **argv)
{
  ...
  gtk_window_set_title (GTK_WINDOW (window), "BlxoWrapTable test");
  ...
  table = blxo_wrap_table_new (TRUE);
  gtk_container_add (GTK_CONTAINER (frame), table);
  gtk_widget_show (table);


  button = gtk_check_button_new_with_label ("Homogeneous");
  blxo_mutual_binding_new (G_OBJECT (table), "homogeneous", G_OBJECT (button), "active");

...
/**
 * blxo_die_g_key_file_set_locale_value:
 ...
 **/
void
blxo_die_g_key_file_set_locale_value (GKeyFile    *key_file,
                                     const gchar *group,
                                     const gchar *key,
                                     const gchar *value)
{
 ...
 **/
gboolean
blxo_die_g_key_file_save (GKeyFile          *key_file,
                         gboolean           create,
                         gboolean           trust,
                         GFile             *base,

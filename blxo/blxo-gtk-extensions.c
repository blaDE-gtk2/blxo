 ...
 *
 * For example, blxo_gtk_file_chooser_add_thumbnail_preview() is a
...
#if GTK_CHECK_VERSION (3, 0, 0)
void
blxo_gtk_object_destroy_later (GtkWidget *object)
{
...
#else
void
blxo_gtk_object_destroy_later (GtkObject *object)
{
                ...
                BlxoThumbnailPreview *thumbnail_preview)
{
  ...
  _blxo_return_if_fail (GTK_IS_FILE_CHOOSER (chooser));
  ...
  _blxo_thumbnail_preview_set_uri (thumbnail_preview, uri);
  g_free (uri);
}
 ...
 **/
void
blxo_gtk_file_chooser_add_thumbnail_preview (GtkFileChooser *chooser)
{
  ...
  thumbnail_preview = _blxo_thumbnail_preview_new ();
  ...
  update_preview (chooser, BLXO_THUMBNAIL_PREVIEW (thumbnail_preview));
}
 ...
 *   gtk_about_dialog_set_email_hook (blxo_gtk_url_about_dialog_hook, NULL, NULL);
 ...
 **/
void
blxo_gtk_url_about_dialog_hook (GtkAboutDialog *about_dialog,
                               const gchar    *address,
                               gpointer        user_data)
{
  GtkWidget *message;
 ...
 **/
GtkWidget *
blxo_gtk_dialog_get_action_area (GtkDialog *dialog)
{
 ...
 **/
void
blxo_gtk_dialog_add_secondary_button (GtkDialog *dialog,
                                     GtkWidget *button)
{
    GtkWidget *button_box;

    button_box = blxo_gtk_dialog_get_action_area (dialog);
...
#define __BLXO_GTK_EXTENSIONS_C__

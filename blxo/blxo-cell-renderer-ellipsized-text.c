...
/**
 * SECTION: blxo-cell-renderer-ellipsized-text
 * @title: BlxoCellRendererEllipsizedText
 ...
 *            <link linkend="BlxoIconView">BlxoIconView</link>
 *
 * The #BlxoCellRendererEllipsizedText renders a given text in its cell,
 ...
 * to render text in an #BlxoIconView (or a #GtkIconView), which require
 * the renderers to actually draw the state indicators. State indicators
 * will be drawn only if the
 * <link linkend="BlxoCellRendererEllipsizedText--follow-state">follow-state</link>
 * property is %TRUE.
 **/
...
static void blxo_cell_renderer_ellipsized_text_get_property  (GObject                            *object,
                                                             guint                               prop_id,
                                                             GValue                             *value,
                                                             GParamSpec                         *pspec);
static void blxo_cell_renderer_ellipsized_text_set_property  (GObject                            *object,
                                                             guint                               prop_id,
                                                             const GValue                       *value,
                                                             GParamSpec                         *pspec);
static void blxo_cell_renderer_ellipsized_text_get_size      (GtkCellRenderer                    *renderer,
                                                             GtkWidget                          *widget,
                                                             ...
                                                             gint                               *width,
                                                             gint                               *height);
static void blxo_cell_renderer_ellipsized_text_render        (GtkCellRenderer                    *renderer,
                                                             GdkWindow                          *window,
                                                             GtkWidget                          *widget,
...
struct _BlxoCellRendererEllipsizedTextPrivate
{
...
G_DEFINE_TYPE_WITH_PRIVATE (BlxoCellRendererEllipsizedText, blxo_cell_renderer_ellipsized_text, GTK_TYPE_CELL_RENDERER_TEXT)



static void
blxo_cell_renderer_ellipsized_text_class_init (BlxoCellRendererEllipsizedTextClass *klass)
{
  GtkCellRendererClass *gtkcell_renderer_class;
  GObjectClass         *gobject_class;

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->get_property = blxo_cell_renderer_ellipsized_text_get_property;
  gobject_class->set_property = blxo_cell_renderer_ellipsized_text_set_property;

  gtkcell_renderer_class = GTK_CELL_RENDERER_CLASS (klass);
  gtkcell_renderer_class->get_size = blxo_cell_renderer_ellipsized_text_get_size;
  gtkcell_renderer_class->render = blxo_cell_renderer_ellipsized_text_render;

  /* initialize the library's i18n support */
  _blxo_i18n_init ();

  /**
   * BlxoCellRendererEllipsizedText:follow-state:
   *
   * Specifies whether the text renderer should render the text based on
   * the selection state of the items. This is necessary for #BlxoIconView
...
static void
blxo_cell_renderer_ellipsized_text_init (BlxoCellRendererEllipsizedText *text)
{
}
...
static void
blxo_cell_renderer_ellipsized_text_get_property (GObject    *object,
                                                guint       prop_id,
                                                GValue     *value,
                                                GParamSpec *pspec)
{
  BlxoCellRendererEllipsizedTextPrivate *priv = blxo_cell_renderer_ellipsized_text_get_instance_private (BLXO_CELL_RENDERER_ELLIPSIZED_TEXT (object));
...
static void
blxo_cell_renderer_ellipsized_text_set_property (GObject      *object,
                                                guint         prop_id,
                                                const GValue *value,
                                                GParamSpec   *pspec)
{
...
static void
blxo_cell_renderer_ellipsized_text_get_size (GtkCellRenderer *renderer,
                                            GtkWidget       *widget,
                                            GdkRectangle    *cell_area,
                                            gint            *x_offset,
                                            gint            *y_offset,
                                            ...
                                            gint            *height)
{
  BlxoCellRendererEllipsizedTextPrivate *priv = blxo_cell_renderer_ellipsized_text_get_instance_private (BLXO_CELL_RENDERER_ELLIPSIZED_TEXT (renderer));
  ...
  (*GTK_CELL_RENDERER_CLASS (blxo_cell_renderer_ellipsized_text_parent_class)->get_size) (renderer, widget, NULL, NULL, NULL, &text_width, &text_height);
...
static void
blxo_cell_renderer_ellipsized_text_render (GtkCellRenderer     *renderer,
                                          GdkWindow           *window,
                                          GtkWidget           *widget,
                                          GdkRectangle        *background_area,
                                          GdkRectangle        *cell_area,
                                          ...
                                          GtkCellRendererState flags)
{
      ...
      if ((flags & (GTK_CELL_RENDERER_FOCUSED | GTK_CELL_RENDERER_SELECTED)) != 0)
        {
          ...
          (*GTK_CELL_RENDERER_CLASS (blxo_cell_renderer_ellipsized_text_parent_class)->get_size) (renderer, widget, &text_area,
  ...
  (*GTK_CELL_RENDERER_CLASS (blxo_cell_renderer_ellipsized_text_parent_class)->render) (renderer, window, widget, background_area,
...
/**
 * blxo_cell_renderer_ellipsized_text_new:
 *
 * Creates a new #BlxoCellRendererEllipsizedText. Adjust rendering parameters using gobject properties,
 ...
 *
 * Returns: the newly allocated #BlxoCellRendererEllipsizedText.
 **/
GtkCellRenderer*
blxo_cell_renderer_ellipsized_text_new (void)
{
  return g_object_new (BLXO_TYPE_CELL_RENDERER_ELLIPSIZED_TEXT, NULL);
}



#define __BLXO_CELL_RENDERER_ELLIPSIZED_TEXT_C__

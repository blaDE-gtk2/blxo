...
#ifndef __BLXO_PRIVATE_H__
#define __BLXO_PRIVATE_H__
...
#ifndef NDEBUG
#define _blxo_assert(expr)                  g_assert (expr)
#define _blxo_assert_not_reached()          g_assert_not_reached ()
#define _blxo_return_if_fail(expr)          g_return_if_fail (expr)
#define _blxo_return_val_if_fail(expr, val) g_return_val_if_fail (expr, (val))
#else
#define _blxo_assert(expr)                  G_STMT_START{ (void)0; }G_STMT_END
#define _blxo_assert_not_reached()          G_STMT_START{ (void)0; }G_STMT_END
#define _blxo_return_if_fail(expr)          G_STMT_START{ (void)0; }G_STMT_END
#define _blxo_return_val_if_fail(expr, val) G_STMT_START{ (void)0; }G_STMT_END
#endif
...
G_GNUC_INTERNAL void  _blxo_i18n_init                    (void);

G_GNUC_INTERNAL void  _blxo_gtk_widget_send_focus_change (GtkWidget         *widget,
                                                         gboolean           in);

G_END_DECLS

#endif /* !__BLXO_PRIVATE_H__ */

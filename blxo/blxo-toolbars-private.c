...
/**
 * _blxo_toolbars_new_separator_pixbuf:
 *
 ...
 **/
GdkPixbuf*
_blxo_toolbars_new_separator_pixbuf (void)
{
  GtkWidget *separator;
  GdkPixbuf *pixbuf;
...
/**
 * _blxo_toolbars_new_separator_image:
 *
 ...
 **/
GtkWidget*
_blxo_toolbars_new_separator_image (void)
{
  GtkWidget *image;
 ...
 **/
GtkAction*
_blxo_toolbars_find_action (GtkUIManager *ui_manager,
                           const gchar  *name)
{
...
/**
 * _blxo_toolbars_set_drag_cursor:
 * @widget  : A #GtkWidget.
 *
 * Changes the #GdkCursor to the dragging appearance.
 **/
void
_blxo_toolbars_set_drag_cursor (GtkWidget *widget)
{
  GdkCursor *cursor;
...
/**
 * _blxo_toolbars_unset_drag_cursor:
 * @widget  : A #GtkWidget.
 *
 * Restores the #GdkCursor to it's default appearance.
 **/
void
_blxo_toolbars_unset_drag_cursor (GtkWidget *widget)
{
  if (G_LIKELY (gtk_widget_get_window (widget) != NULL))

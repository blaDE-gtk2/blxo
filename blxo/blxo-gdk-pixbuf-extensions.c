...
/**
 * SECTION: blxo-gdk-pixbuf-extensions
 ...
 **/
GdkPixbuf*
blxo_gdk_pixbuf_colorize (const GdkPixbuf *source,
 ...
 **/
GdkPixbuf*
blxo_gdk_pixbuf_frame (const GdkPixbuf *source,
 ...
 **/
GdkPixbuf*
blxo_gdk_pixbuf_lucent (const GdkPixbuf *source,
                       guint            percent)
{
  GdkPixbuf *dst;
  guchar    *dst_pixels;
 ...
 **/
GdkPixbuf*
blxo_gdk_pixbuf_spotlight (const GdkPixbuf *source)
{
  GdkPixbuf *dst;
  gboolean   has_alpha;
  gint       dst_row_stride;
 ...
 **/
GdkPixbuf*
blxo_gdk_pixbuf_scale_down (GdkPixbuf *source,
 ...
 **/
GdkPixbuf*
blxo_gdk_pixbuf_scale_ratio (GdkPixbuf *source,
                            gint       dest_size)
{
  gdouble wratio;
  gdouble hratio;
...
/**
 * blxo_gdk_pixbuf_new_from_file_at_max_size:
 ...
 **/
GdkPixbuf*
blxo_gdk_pixbuf_new_from_file_at_max_size (const gchar *filename,
                                          gint         max_width,
                                          gint         max_height,
                                          gboolean     preserve_aspect_ratio,
                                          GError     **error)
...
#define __BLXO_GDK_PIXBUF_EXTENSIONS_C__

...
#include <blxo/blxo.h>
#include <blxo-helper/blxo-helper-chooser-dialog.h>




static void blxo_helper_chooser_dialog_init      (BlxoHelperChooserDialog *chooser_dialog);
static void blxo_helper_chooser_dialog_show_help (BlxoHelperChooserDialog *dialog);



struct _BlxoHelperChooserDialogClass
{
  XfceTitledDialogClass __parent__;
};

struct _BlxoHelperChooserDialog
{
...
GType
blxo_helper_chooser_dialog_get_type (void)
{
  ...
  if (G_UNLIKELY (type == G_TYPE_INVALID))
    {
      ...
      {
        sizeof (BlxoHelperChooserDialogClass),
        NULL,
        NULL,
        NULL,
        NULL,
        NULL,
        sizeof (BlxoHelperChooserDialog),
        0,
        (GInstanceInitFunc) (void (*)(void)) blxo_helper_chooser_dialog_init,
        NULL,
      };

      type = g_type_register_static (XFCE_TYPE_TITLED_DIALOG, I_("BlxoHelperChooserDialog"), &info, 0);
    }
...
static void
blxo_helper_chooser_dialog_init (BlxoHelperChooserDialog *chooser_dialog)
{
  ...
  g_assert (BLXO_HELPER_N_CATEGORIES == 4);
  ...
  gtk_button_set_image (GTK_BUTTON (button), image);
  g_signal_connect_swapped (G_OBJECT (button), "clicked", G_CALLBACK (blxo_helper_chooser_dialog_show_help), chooser_dialog);
  blxo_gtk_dialog_add_secondary_button (GTK_DIALOG (chooser_dialog), GTK_WIDGET (button));
  gtk_widget_show (button);
  ...
  chooser = blxo_helper_chooser_new (BLXO_HELPER_WEBBROWSER);
  ...
  chooser = blxo_helper_chooser_new (BLXO_HELPER_MAILREADER);
  gtk_box_pack_start (GTK_BOX (box), chooser, FALSE, FALSE, 0);
  gtk_widget_show (chooser);
  ...
  chooser = blxo_helper_chooser_new (BLXO_HELPER_FILEMANAGER);
  gtk_box_pack_start (GTK_BOX (box), chooser, FALSE, FALSE, 0);
  gtk_widget_show (chooser);
  ...
  chooser = blxo_helper_chooser_new (BLXO_HELPER_TERMINALEMULATOR);
  gtk_box_pack_start (GTK_BOX (box), chooser, FALSE, FALSE, 0);
  gtk_widget_show (chooser);
...
static void
blxo_helper_chooser_dialog_show_help (BlxoHelperChooserDialog *chooser_dialog)
{
  g_return_if_fail (BLXO_IS_HELPER_CHOOSER_DIALOG (chooser_dialog));
  xfce_dialog_show_help (GTK_WINDOW (chooser_dialog), "blxo",
...
/**
 * blxo_helper_chooser_dialog_new:
 *
 * Allocates a new #BlxoHelperChooserDialog.
 *
 * Return value: the newly allocated #BlxoHelperChooserDialog.
 **/
GtkWidget*
blxo_helper_chooser_dialog_new (void)
{
  return g_object_new (BLXO_TYPE_HELPER_CHOOSER_DIALOG, NULL);
}


/**
 * blxo_helper_chooser_dialog_get_plug_child:
 * @dialog: A #BlxoHelperChooserDialog.
 *
 ...
 **/
GtkWidget *
blxo_helper_chooser_dialog_get_plug_child (BlxoHelperChooserDialog *dialog)
{
